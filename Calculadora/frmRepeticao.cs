...
namespace Calculadora
{
    public partial class frmRepeticao : Form
    {
        ...
        private void frmRepeticao_Load(object sender, EventArgs e)
        {

        }

        private void ltbCategorias_SelectedIndexChanged(object sender, EventArgs e)
        {
